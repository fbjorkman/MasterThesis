...
export declare class NzColDirective implements OnInit, OnChanges, AfterViewInit, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NzColDirective, [null, { optional: true; host: true; }, null, { optional: true; }]>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<NzColDirective, "[nz-col],nz-col,nz-form-control,nz-form-label", ["nzCol"], { "nzFlex": "nzFlex"; "nzSpan": "nzSpan"; "nzOrder": "nzOrder"; "nzOffset": "nzOffset"; "nzPush": "nzPush"; "nzPull": "nzPull"; "nzXs": "nzXs"; "nzSm": "nzSm"; "nzMd": "nzMd"; "nzLg": "nzLg"; "nzXl": "nzXl"; "nzXXl": "nzXXl"; }, {}, never>;
}
