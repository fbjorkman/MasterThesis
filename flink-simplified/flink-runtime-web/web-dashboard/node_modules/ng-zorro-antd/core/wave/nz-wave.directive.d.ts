...
export declare class NzWaveDirective implements OnInit, OnDestroy {
    ...
    disable(): void;
    enable(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NzWaveDirective, [null, null, { optional: true; }, { optional: true; }, null]>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<NzWaveDirective, "[nz-wave],button[nz-button]:not([nzType=\"link\"]):not([nzType=\"text\"])", ["nzWave"], { "nzWaveExtraNode": "nzWaveExtraNode"; }, {}, never>;
}

//# sourceMappingURL=nz-wave.directive.d.ts.map