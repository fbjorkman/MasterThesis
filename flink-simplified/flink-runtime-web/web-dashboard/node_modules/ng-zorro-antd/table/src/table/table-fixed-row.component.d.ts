...
export declare class NzTableFixedRowComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NzTableFixedRowComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NzTableFixedRowComponent, "tr[nz-table-fixed-row], tr[nzExpand]", never, {}, {}, never, ["*"]>;
}

//# sourceMappingURL=table-fixed-row.component.d.ts.map