...
export declare class NzAutosizeDirective implements AfterViewInit, OnDestroy, DoCheck {
    ...
    ngOnDestroy(): void;
    ngDoCheck(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NzAutosizeDirective, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<NzAutosizeDirective, "textarea[nzAutosize]", ["nzAutosize"], { "nzAutosize": "nzAutosize"; }, {}, never>;
}
