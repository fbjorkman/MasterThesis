...
package org.apache.flink.streaming.examples.rocksdbtest;
  ...
  public static void main(String[] args) throws Exception {
    ...
    DataStream<Tuple2<String, Integer>> counts =
            text.flatMap(new WordCount.Tokenizer())
                    ...
                    .sum(1);
//    counts.writeAsText("flink-examples/flink-examples-streaming/src/main/java/org/apache/flink/streaming/examples/rocksdbtest/out");
